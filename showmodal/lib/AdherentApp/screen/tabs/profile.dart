...
class _ProfilePageState extends State<ProfilePage>
  ...
  getRole() async {
   ...
   await MyCache.getUserRole();

  }
  late OfferProvider role ;
  @override
  void initState() {
    role = OfferProvider();
  ...
  Widget build(BuildContext context) {
    final authProvider = Provider.of<AuthProvider>(context);
        final role = Provider.of<OfferProvider>(context);
  ...
  Widget Setting(BuildContext context) {
    ...
    return ListView(
      children: [
        ...
        role.role.toString().toLowerCase() == ServiceConst.RolePartenaire.toLowerCase()
            ? _buildListTile('CONTINUE_AS_PARTENAIRE'.tr, FontAwesomeIcons.user, '',
